...
module Language.Haskell.Exts.Desugaring 
       ...
       ,module Language.Haskell.Exts.Desugar.Type
       ,module Language.Haskell.Exts.Desugar.Pattern
       ,module Language.Haskell.Exts.Desugar.Case
       ,module Language.Haskell.Exts.Desugar.Conversion
       ,module Language.Haskell.Exts.Desugar.Expression
       ,module Language.Haskell.Exts.Desugar.Record
       ) where
